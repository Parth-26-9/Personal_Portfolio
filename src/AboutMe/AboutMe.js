...
return (
    <div className='co'>
    {
        ...
        <p className='about-me-text'>I'm BCA Student(2021-2024) of Marwadi University</p>
        <p className='about-me-text'>I Would Like to Make Frontend Web Pages</p>
        <div className="icons">
          <i className="fa-brands fa-linkedin" id='link' onClick={linkedIn}></i>
